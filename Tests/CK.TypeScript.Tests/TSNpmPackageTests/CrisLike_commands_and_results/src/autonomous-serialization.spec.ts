...
it('O map with projection can use 2 methods.', () => {
  ...
  // We use Object.fromEntries(a) above, not the below code.
  let o = {};
  for (const i of map) {
    (<any>o)[i[0]] = f(i[1]);
  }
...
describe('Command serialization', () => {
  ...
  it('WithDecimalCommand.', () => {
    ...
    expect(s).toEqual( '["CK.TypeScript.Tests.TSTests.FullTSTests.IWithDecimalCommand",{"value":"3712"}]' );
  ...
  it('WithULongCommand.', () => {
    ...
    const json = CTSType.toTypedJson( c );
    const s = JSON.stringify(json);
    expect(s).toEqual( '["CK.TypeScript.Tests.TSTests.FullTSTests.IWithULongCommand",{"value":"99999999"}]' );
    const raw = JSON.parse(s);
    const back = CTSType.fromTypedJson( raw );
    expect( back ).toStrictEqual( c );
  ...
  it('WithBigIntegerCommand.', () => {
    ...
    const json = CTSType.toTypedJson( c );
    const s = JSON.stringify(json);
    expect(s).toEqual( '["CK.TypeScript.Tests.TSTests.FullTSTests.IWithBigIntegerCommand",{"value":"99999999"}]' );
    const raw = JSON.parse(s);
    const back = CTSType.fromTypedJson( raw );
    expect( back ).toStrictEqual( c );
  ...
  it('TestSerializationCommand with basic types.', () => {
    ...
    var c = new TestSerializationCommand( 
      ...
      expect(s).toEqual( '["CK.TypeScript.Tests.TSTests.FullTSTests.ITestSerializationCommand",{"string":"A string","int32":42,"single":3.7,"double":3.141592653589793,"long":"9999","uLong":"-87878","bigInteger":"99999999","grantLevel":32,"typeKind":13,"guid":"d0acf1b1-4675-4a23-af51-3c834d910f3d","dateTime":"2024-03-06T13:26:12.854Z","timeSpan":"37120000","simpleUserMessage":[4,"Hello!",0],"decimal":"79228162514264337593543950335"}]' );
    ...
    it( 'Command with records.', () => {
      ...
      expect(json).toEqual('["CK.TypeScript.Tests.CrisLike.INamedRecordCommand",{"key":{"value":3712,"name":"Hello"},"keyList":[{"value":3712,"name":"Hello"},{"value":42,"name":"another"}],"keySet":[{"value":1,"name":"One"},{"value":2,"name":"Two"}],"keyDictionary":{"n°1":{"value":3712,"name":"Hello"},"n°2":{"value":-3712,"name":"Last one"}}}]');
    ...
    it( 'Command with anonymous records.', () => {
      ...
      const json = CTSType.stringify( c );
      expect(json).toEqual('["CK.TypeScript.Tests.CrisLike.IAnonymousRecordCommand",{"key":[3712,"00000000-0000-0000-0000-000000000000"],"keyTuple":[42,"some guid..."],"keyHybrid":[42,"some other guid."],"keyList":[[3712,"00000000-0000-0000-0000-000000000000"],[42,"our simple guid allow any string"]],"keySet":[[1,"in set 1"],[27,"in set 2"]],"keyDictionary":{"n°1":[-1,"in dic 1"],"n°2":[-2,"in dic 1"]}}]');
      const back = CTSType.parse( json );      
      expect( back ).toStrictEqual( c );
    });
    ...
    it( 'Command with commands.', () => {
      ...
      expect(json1).toEqual('["CK.TypeScript.Tests.CrisLike.ICommandCommand",{"key":null,"keyList":[],"keySet":[],"keyDictionary":{}}]');
      ...
      expect(json2).toEqual('["CK.TypeScript.Tests.CrisLike.ICommandCommand",{"key":["CK.TypeScript.Tests.CrisLike.ISomeCommand",{"actionId":"...guid...","actorId":3712}],"keyList":[],"keySet":[],"keyDictionary":{}}]');
      ...
      expect(json3).toEqual('["CK.TypeScript.Tests.CrisLike.ICommandCommand",{"key":["CK.TypeScript.Tests.CrisLike.ISomeCommand",{"actionId":"...guid...","actorId":3712}],"keyList":[["CK.TypeScript.Tests.CrisLike.ISomeCommand",{"actionId":"...guid...","actorId":3712}],["CK.TypeScript.Tests.CrisLike.ISimplestCommand",{}],["CK.TypeScript.Tests.CrisLike.ISimpleCommand",{"action":"do!"}]],"keySet":[],"keyDictionary":{}}]');
