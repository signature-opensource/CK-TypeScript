...
export class WithULongCommand implements ICommand {
public value: bigint;
public constructor()
public constructor(
value?: bigint)
...
{
this.value = value ?? 0n;
CTSType["CK.TypeScript.Tests.TSTests.FullTSTests.IWithULongCommand"].set( this );
}

get commandModel(): ICommandModel { return WithULongCommand.#m; }
...
readonly _brand!: ICommand["_brand"] & {"22":any};
}
