import { SamplePoco } from '../TS/JsonGraphSerializer/Tests/SamplePoco';
...
export const CTSType : any = {
    get typeFilterName(): string {return "TypeScriptC1"; },
...
"CK.TS.JsonGraphSerializer.Tests.MultipleTypeScriptTests.ISamplePoco": {
name: "CK.TS.JsonGraphSerializer.Tests.MultipleTypeScriptTests.ISamplePoco",
set( o: SamplePoco ): SamplePoco {  (o as any)[SymCTS] = this; return o; },
json( o: any ) {return o;
},
nosj( o: any ) {if( o == null ) return undefined;
return new SamplePoco(
CTSType["string"].nosj( o.data ),
CTSType["float"].nosj( o.value ) );
},
},
"CK.Core.IPoco": {
name: "CK.Core.IPoco",
