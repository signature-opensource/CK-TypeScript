...
exports.SymCTS = exports.CTSType = void 0;
exports.CTSType = {
    toTypedJson(o) {
        if (o == null)
            return null;
        const t = o[exports.SymCTS];
        if (!t)
    ...
    stringify(o, withType = true) {
        var t = exports.CTSType.toTypedJson(o);
        return JSON.stringify(withType ? t : t[1]);
    },
    parse(s) {
        return exports.CTSType.fromTypedJson(JSON.parse(s));
    },
};
exports.SymCTS = Symbol.for("CK.CTSType");
