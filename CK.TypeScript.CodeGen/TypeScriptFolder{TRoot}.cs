...
namespace CK.TypeScript.CodeGen
{
        ...
        where TRoot : TypeScriptRoot
    {
        ...
        public new IEnumerable<TypeScriptFolder<TRoot>> Folders => Unsafe.As<IEnumerable<TypeScriptFolder<TRoot>>>( base.Folders );
        ...
        public new IEnumerable<TypeScriptFile<TRoot>> Files => Unsafe.As<IEnumerable<TypeScriptFile<TRoot>>>( base.Files );
