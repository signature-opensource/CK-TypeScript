...
public interface ITSFileImportSection
{
    ...
    /// <param name="typeNames">More types to import (optionals).</param>
    /// <returns>This section to enable fluent syntax.</returns>
    ITSFileImportSection EnsureImport( IMinimalTypeScriptFile file, string typeName, params string[] typeNames );
    ...
    /// <summary>
    /// Gets the number of TypeScript type name that has been imported.
    /// </summary>
    int ImportTypeCount { get; }
