...
public sealed class UnexpectedTokenNode : TokenNode, IErrorTolerantNode
{
    ...
    public UnexpectedTokenNode( ReadOnlyMemory<char> text, TokenType tokenType = TokenType.GenericUnexpectedToken, ImmutableArray<Trivia> leading = default, ImmutableArray<Trivia> trailing = default )
