...
public abstract class TransformLanguage
{
    ...
    internal protected abstract BaseTransformAnalyzer CreateTransformAnalyzer( TransformerHost host );
    ...
    /// <param name="target">A <see cref="RawString"/> or a <see cref="TokenNode"/>.</param>
