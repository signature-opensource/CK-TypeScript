...
public class RawNodeList : CollectionNode, IAbstractNodeList<AbstractNode>
{
    ...
    /// <param name="children">The children.</param>
    public RawNodeList( TokenType nodeType, ImmutableArray<Trivia> leading, ImmutableArray<Trivia> trailing, ImmutableArray<AbstractNode> children )
        : base( leading, trailing, children )
    {
        _nodeType = nodeType;
    }

    public override TokenType NodeType => _nodeType;
