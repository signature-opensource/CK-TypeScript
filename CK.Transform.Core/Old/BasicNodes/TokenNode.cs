...
public class TokenNode : AbstractNode, IEnumerable<TokenNode>
{
    ...
    public static TokenNode CreateMarker( TokenType type = TokenType.GenericMarkerToken ) => new TokenNode( ImmutableArray<Trivia>.Empty, ImmutableArray<Trivia>.Empty, type, default );

    /// <summary>
    /// The token type. It can be an error if this is a <see cref="TokenErrorNode"/>.
    /// </summary>
    public override sealed TokenType NodeType => _tokenType;
