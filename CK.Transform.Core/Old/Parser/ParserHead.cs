...
public ref struct ParserHead
{
    ...
    /// <returns>A token error node.</returns>
    public TokenErrorNode CreateError( TokenType errorType, int length, string? errorMessage = null )
    {
        Throw.CheckArgument( errorType.IsError() );
    ...
    public TokenNode CreateToken( TokenType type, int tokenLength )
    {
    ...
    /// <returns>The token node.</returns>
    public TokenNode CreateLowLevelToken( TokenType type = TokenType.None )
    {
    ...
    /// <param name="result">The non null TokenNode on success.</param>
    /// <returns>True on success, false otherwise.</returns>
    public bool TryMatchToken( TokenType type, [NotNullWhen( true )] out TokenNode? result )
    {
    ...
    /// <returns>The Token or TokenError node.</returns>
    public TokenNode MatchToken( TokenType type, string tokenDescription )
    {
