...
public class NodeLocation : IComparable<NodeLocation>
{
    ...
    /// </summary>
    public static readonly TokenNode BegOfInput = TokenNode.CreateMarker( TokenType.BegOfInput );

    /// <summary>
    /// The end of input marker.
    /// </summary>
    public static readonly TokenNode EndOfInput = TokenNode.CreateMarker( TokenType.EndOfInput );
