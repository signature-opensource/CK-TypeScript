...
sealed class TriviaInjectionPointMatcher
{
    ...
    readonly InjectionPointOld _injectionPoint;
    readonly RawStringOld _injectedCode;
    bool _foundInsertPoint;
    bool _foundOpening;
    bool _foundOpeningIsAutoClosing;
    bool _foundOpeningIsRevert;

    public TriviaInjectionPointMatcher( IActivityMonitor monitor, InjectionPointOld injectionPoint, RawStringOld injectedCode )
    {
        _monitor = monitor;
    ...
    /// </summary>
    public InjectionPointOld InjectionPoint => _injectionPoint;
