...
/// (that could specialize <see cref="TypeScriptTypeAttributeImpl"/>).
/// <para>
...
public interface ITSCodeGeneratorType : ITSCodeGeneratorAutoDiscovery
{
    ...
    /// If a <see cref="TypeScriptTypeAttribute"/> decorates the type, its properties have been applied to the builder.
    /// <para>
