...
sealed class AngularJestSetupHandler : TypeScriptIntegrationContext.JestSetupHandler
{
    ...
    {
        bool withLegacyZone = Context.TargetPackageJson.Dependencies.ContainsKey( "zone.js" );
        var zoneLessMarker = withLegacyZone ? "" : "less";
        string content = $$"""
            //-AllowAutoUpdate
            // Generated by: CK.TS.Angular.Engine.AngularJestSetupHandler.
            import { setupZone{{zoneLessMarker}}TestEnv } from 'jest-preset-angular/setup-env/zone{{zoneLessMarker}}';
            setupZone{{zoneLessMarker}}TestEnv();
