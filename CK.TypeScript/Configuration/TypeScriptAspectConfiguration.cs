...
public sealed partial class TypeScriptAspectConfiguration : EngineAspectConfiguration
{
    ...
    /// <summary>
    /// Gets the "CK.Setup.TypeScriptAspect, CK.TypeScript.Engine" assembly qualified name.
    /// </summary>
    public override string AspectType => "CK.Setup.TypeScriptAspect, CK.TypeScript.Engine";
